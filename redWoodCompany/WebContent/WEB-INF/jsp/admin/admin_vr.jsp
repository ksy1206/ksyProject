...
<div class="container-fluid" style="margin-left: 5em; margin-right: 5em;">
  <h1>vr 올리기</h1>
	...
	<form id="file_upload" name="file_upload" method="post" enctype="multipart/form-data" action="<%=cp%>/comm/saveMP4Upload.do?fileGbn=main">
